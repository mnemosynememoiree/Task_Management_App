...
class TaskTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Alternate pastel card background colors
    final cardColor = task.isCompleted
        ? AppColors.completedTask.withValues(alpha: 0.08)
        : isOverdue
            ? AppColors.error.withValues(alpha: 0.08)
            : AppColors.taskCardColors[index % AppColors.taskCardColors.length];
  ...
  Widget _buildCheckbox(BuildContext context, task) {
    return SizedBox(
      width: 24,
      height: 24,
      child: Checkbox(
